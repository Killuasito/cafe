  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <motion.div
          className="h-12 w-12 border-4 border-yellow-950 border-t-transparent rounded-full"
          animate={{ rotate: 360 }}
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto p-6">
        {/* Header Section */}
        <motion.div
          className="bg-gradient-to-r from-yellow-900 to-yellow-800 rounded-lg shadow-lg mb-8 p-8"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {stats.recentOrders.map((order, index) => (
                  <motion.tr
                    ...
                    whileHover={{ backgroundColor: "#FEFAF0" }}
                  >
